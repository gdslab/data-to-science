...
import { IndoorProjectDataViz2APIResponse } from '../components/pages/workspace/indoorProjects/IndoorProject';

interface FetchTraitVisualizationParams {
...
export async function fetchTraitVisualizationData({
  indoorProjectId,
  indoorProjectDataId,
  cameraOrientation,
  groupBy,
  targetTrait,
}: FetchTraitVisualizationParams): Promise<IndoorProjectDataViz2APIResponse> {
