...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "sensor",
            postgresql.ENUM(
                "RGB", "Multispectral", "LiDAR", "Other", name="sensor_type"
            ),
            nullable=False,
        ),
        sa.Column(
            "platform",
            postgresql.ENUM("Phantom_4", "M300", "M350", "Other", name="platform_type"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "data_type",
            postgresql.ENUM("dsm", "point_cloud", "ortho", "other", name="dtype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "state",
            postgresql.ENUM("PENDING", "STARTED", "COMPLETED", name="job_state"),
            nullable=False,
        ),
        sa.Column(
            "status",
            postgresql.ENUM(
                "WAITING", "INPROGRESS", "SUCCESS", "FAILED", name="job_status"
            ),
            nullable=False,
        ),
