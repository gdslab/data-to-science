"""drop tiger schema and other unused tables

Revision ID: 18275fe01c4f
Revises: 89477cf7fcf0
Create Date: 2023-11-28 14:32:15.908204
...
revision = '18275fe01c4f'
down_revision: str | None = '89477cf7fcf0'
...
def upgrade() -> None:
    ...
    op.execute('drop schema tiger cascade')
...
def downgrade() -> None:
    ...
    op.create_geospatial_index('tiger_faces_the_geom_gist', 'faces', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index('idx_tiger_edges_the_geom_gist', 'edges', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index('tiger_place_the_geom_gist', 'place', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index('tige_cousub_the_geom_gist', 'cousub', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index('idx_addrfeat_geom_gist', 'addrfeat', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
    ...
    op.create_geospatial_index('idx_tiger_state_the_geom_gist', 'state', ['the_geom'], unique=False, postgresql_using='gist', postgresql_ops={})
