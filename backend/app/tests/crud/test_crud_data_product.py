...
def test_create_data_product(db: Session) -> None:
    ...
    assert data_product
    assert flight.id == data_product.flight_id
    assert data_product.original_filename
...
def test_get_data_product(db: Session) -> None:
    ...
    assert data_product.id == stored_data_product.id
    assert flight.id == stored_data_product.flight_id
    assert data_product.filepath == stored_data_product.filepath
    assert stored_data_product.original_filename
