    ...
    if (flightId) {
      if (flights && flights.length > 0) {
        ...
        if (currentFlight && currentFlight.length > 0) {
          const platDate = `${currentFlight[0].platform} - ${currentFlight[0].acquisition_date}`;
          setFlightCrumb(platDate);
          localStorage.setItem(currentFlight[0].id, platDate);
        }
      } else {
